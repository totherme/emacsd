...
* Twitter
  :PROPERTIES:
  :ID:       5f5d3df5-93dc-4fe5-b9bf-0237f7b6e66c
  :END:
  #+begin_src emacs-lisp
...
* Reddit
  :PROPERTIES:
  :ID:       e2e30881-1640-4a60-970d-0506d856779e
  :END:
  There's a reddit emacs package [[https://github.com/ahungry/md4rd][on github here]]. According to the
  installation instructions as I write this, it needs to be cloned
  locally, and included manually. Hence the check below to see if
  =~/workspace/md4rd= exists.
  ...
  #+begin_src emacs-lisp
    ...
    (if (file-exists-p "~/workspace/md4rd")
        (progn
          (add-to-list 'load-path "~/workspace/md4rd")
          (require 'md4rd)))
  #+end_src
